 ...
 * @author jackson
 */
public class LifWindow extends javax.swing.JFrame {
    MainWindow program;
    /**
     * Creates new form LifWindow
     */
    public LifWindow(MainWindow w) {
        initComponents();
        program = w;
        
        this.setVisible(true);
        //this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("eagleyeicon.jpg")));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EagleEye .lif Display");
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/eetorc/eagleeyeicon.jpg"))); // NOI18N

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/eetorc/eagleeyeicon.jpg"))); // NOI18N
           ...
           else
           {
               ...
               for(int i = 0; i < jTable1.getRowCount(); i++)
               {
                   if(Integer.parseInt(jTable1.getValueAt(i, 0).toString()) == Integer.parseInt(input))
                   {
                       ...
                       String choosen = jTable1.getValueAt(i, 2).toString();
    ...
    public void addRow(String lane, String place, String time)
    {
        //Create string array (row) from parameters. 
        String[] data = {lane, place, time};        
