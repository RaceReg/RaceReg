 ...
 */
public class Heat {
    private ArrayList<Racer> runners;
    private int heatNum;
    
    public Heat(int n)
    {
        runners = new ArrayList<Racer>();
        heatNum = n;
    }
    ...
    public void addTimeToRacer(String lane, String t)
    {
        for(int i = 0; i < runners.size(); i++)
        {
    ...
    public void addPlaceNumber()
    {
        ...
        ArrayList<Racer> temp = new ArrayList<Racer>();
        ArrayList<Racer> temp2 = new ArrayList<Racer>();
        ArrayList<Racer> noTimesTemp = new ArrayList<Racer>();
    ...
    public ArrayList<Racer> getRacersByLane()
    {
        addPlaceNumber();
        ...
        {           
            ...
            {
                JOptionPane.showMessageDialog(null, "Error! Empty Racer List! Terminating.", "Error", JOptionPane.ERROR_MESSAGE);
                System.exit(1);
            }
